...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * LuaFunction WBP_AlertBox_p.WBP_AlertBox_p_C.CallLuaCommonUIFunction
	 */
	struct UWBP_AlertBox_p_C_CallLuaCommonUIFunction_Params
	{
	public:
	...
	/**
	 * LuaFunction WBP_AlertBox_p.WBP_AlertBox_p_C.BP_OnHandleBackAction
	 */
	struct UWBP_AlertBox_p_C_BP_OnHandleBackAction_Params
	{
	public:
