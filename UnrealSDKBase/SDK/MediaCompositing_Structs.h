...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_82SZ[0x3];                                   // 0x0045(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_VWKZ[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
