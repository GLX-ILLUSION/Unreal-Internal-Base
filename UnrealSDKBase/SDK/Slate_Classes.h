...
namespace CG
{
	...
	{
	public:
		struct FScrollBarStyle                                     ScrollBarStyle;                                          // 0x0030(0x04D8) Edit, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                              UnknownData_5TOK[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (PADDING)
