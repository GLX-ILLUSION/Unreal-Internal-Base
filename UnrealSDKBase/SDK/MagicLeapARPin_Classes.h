...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FI75[0x2];                                   // 0x020E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DEWK[0xF0];                                  // 0x02C0(0x00F0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_G5OP[0x7];                                   // 0x0239(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TLQX[0x7];                                   // 0x0229(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*>    AllInfoActors;                                           // 0x0230(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_DWJC[0x8];                                   // 0x0280(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_DSU6[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RAGY[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (PADDING)
