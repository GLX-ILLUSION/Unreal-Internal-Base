...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_Z0O5[0x8];                                   // 0x0478(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_0P8A[0x6];                                   // 0x0482(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PNJB[0x4];                                   // 0x04CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
